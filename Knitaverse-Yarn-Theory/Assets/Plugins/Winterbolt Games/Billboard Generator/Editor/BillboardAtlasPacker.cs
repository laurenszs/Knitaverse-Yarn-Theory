...
namespace WinterboltGames.BillboardGenerator.Editor
{
	internal sealed class BillboardAtlasPacker : EditorWindow
	{
		...
		private void Pack()
		{
			(Texture2D texture, System.Collections.Generic.List<Runtime.UVCoordinates> uvs) = PackingUtilities.PackTight(textures, choiceHeuristic, initialBinWidth, initialBinHeight);
